        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcquriedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_characters_titles", x => new { x.CharacterId, x.TitleId });
                    table.ForeignKey(
                        name: "FK_characters_titles_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_characters_titles_Titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 20, "Mariusz", "Kowalski", 30 });

            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "Name", "Weight" },
                values: new object[] { 1, "Bidon", 2 });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CharacterId", "TitleId", "AcquriedAt" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_characters_titles_TitleId",
                table: "characters_titles",
                column: "TitleId");
        }
